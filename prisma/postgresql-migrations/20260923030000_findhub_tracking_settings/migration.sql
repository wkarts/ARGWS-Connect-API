...
ALTER TABLE "FindHubAccount" ADD COLUMN "trackingSettings" JSONB NULL;
ALTER TABLE "FindHubAccount" ADD COLUMN "encryptedTraccar" TEXT NULL;
ALTER TABLE "FindHubDevice" ADD COLUMN "latestPosition" JSONB NULL;
ALTER TABLE "FindHubDevice" ADD COLUMN "lastReceivedAt" TIMESTAMP(3) NULL;
ALTER TABLE "FindHubDevice" ADD COLUMN "lastAttemptAt" TIMESTAMP(3) NULL;
