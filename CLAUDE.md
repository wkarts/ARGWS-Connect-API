...
This file provides comprehensive guidance to Claude AI when working with the ARGWS Connect API codebase.

## Project Overview

**ARGWS Connect API** is a powerful, production-ready REST API for WhatsApp communication that supports multiple WhatsApp providers:
- **Baileys** (WhatsApp Web) - Open-source WhatsApp Web client
- **Meta Business API** - Official WhatsApp Business API
- **ARGWS Connect API** - Custom WhatsApp integration
...
- **WhatsApp integrations**: Baileys, Meta Business API, and ARGWS Connect API with unified interface
...
│   │   ├── channel/    # WhatsApp providers (Baileys, Business API, Connect)
...
- **ConnectBot**: Native chatbot with trigger system
...
- **ConnectAI**: Custom AI integration
...
- ARGWS LICENSYS telemetry for usage analytics (opt-in, best-effort, non-sensitive data only)