...
const connectBotService = new ConnectBotService(waMonitor, prismaRepository, configService, openaiService);
export const connectBotController = new ConnectBotController(connectBotService, prismaRepository, waMonitor);
...
const connectAIService = new ConnectAIService(waMonitor, prismaRepository, configService, openaiService);
export const connectAIController = new ConnectAIController(connectAIService, prismaRepository, waMonitor);
