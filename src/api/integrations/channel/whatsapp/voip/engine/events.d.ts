...
export interface VoipEvents {
  ...
  readonly voip_call_inbound_audio: (payload: { readonly call: CallInfo; readonly pcm: Float32Array }) => void;
  readonly voip_call_inbound_video: (payload: {
    readonly call: CallInfo;
    readonly frame: import('./types.js').InboundVideoFrame;
  }) => void;
  readonly voip_call_video_keyframe_request: (payload: { readonly callId: string }) => void;
