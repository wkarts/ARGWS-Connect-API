...
export interface CallOfferOptions {
   ...
   * media flows through the Connect-owned H.264 adapter and WhatsApp relay.
   */
  isVideo?: boolean;
...
export interface CallManagerEvents {
  ...
  call_video_keyframe_request: (call: CallInfo) => void;
...
export declare const WA_DTLS_FINGERPRINT =
