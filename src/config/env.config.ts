...
export type ConnectAI = { ENABLED: boolean };
...
export class ConfigService {
  ...
  private envProcess(): Env {
    return {
      SERVER: {
        NAME: process.env?.SERVER_NAME || 'argws-connect-api',
      ...
      PROVIDER: {
        ...
        PREFIX: process.env?.PROVIDER_PREFIX || 'argws-connect',
      },
      DATABASE: {
        CONNECTION: {
          URI: process.env.DATABASE_CONNECTION_URI || '',
          CLIENT_NAME: process.env.DATABASE_CONNECTION_CLIENT_NAME || 'argws-connect-api',
        },
      ...
      RABBITMQ: {
        ...
        EXCHANGE_NAME: process.env?.RABBITMQ_EXCHANGE_NAME || 'argws_connect_exchange',
      ...
      NATS: {
        ...
        EXCHANGE_NAME: process.env?.NATS_EXCHANGE_NAME || 'argws_connect_exchange',
      ...
      KAFKA: {
        ...
        CLIENT_ID: process.env?.KAFKA_CLIENT_ID || 'argws-connect-api',
        ...
        CONSUMER_GROUP_ID: process.env?.KAFKA_CONSUMER_GROUP_ID || 'argws-connect-api-consumers',
        TOPIC_PREFIX: process.env?.KAFKA_TOPIC_PREFIX || 'argws-connect',
      ...
      WA_BUSINESS: {
        TOKEN_WEBHOOK: process.env.WA_BUSINESS_TOKEN_WEBHOOK || 'argws-connect',
      ...
      CONNECT_AI: {
        ENABLED: process.env?.CONNECT_AI_ENABLED === 'true',
      },
      FLOWISE: {
      ...
      CACHE: {
        REDIS: {
          ...
          PREFIX_KEY: process.env?.CACHE_REDIS_PREFIX_KEY || 'argws-connect-cache',
      ...
      TELEMETRY: {
        ENABLED: process.env?.ARGWS_CONNECT_TELEMETRY_ENABLED === 'true',
        MODE: process.env?.ARGWS_CONNECT_TELEMETRY_MODE === 'direct' ? 'direct' : 'agent',
        URL: process.env?.ARGWS_CONNECT_TELEMETRY_URL || 'http://127.0.0.1:47831/v1/telemetry',
        AGENT_TOKEN: process.env?.ARGWS_CONNECT_TELEMETRY_AGENT_TOKEN,
        ACTIVATION_TOKEN: process.env?.ARGWS_CONNECT_TELEMETRY_ACTIVATION_TOKEN,
        SCHEMA: process.env?.ARGWS_CONNECT_TELEMETRY_SCHEMA || 'argws.connect.api.route',
        SCHEMA_VERSION: Number.parseInt(process.env?.ARGWS_CONNECT_TELEMETRY_SCHEMA_VERSION || '1'),
        TIMEOUT_MS: Number.parseInt(process.env?.ARGWS_CONNECT_TELEMETRY_TIMEOUT_MS || '3000'),
      },
      PROXY: {
