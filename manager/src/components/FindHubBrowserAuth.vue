    ...
    await new Promise<void>((resolve, reject) => {
      ...
      port.onMessage.addListener((message: any) => {
        ...
        if (!compatibleFindHubHelper(message.version)) {
          reject(new Error('Atualize a extensão Find Hub Auth para 0.1.3 ou superior, recarregue-a na página de extensões e atualize o Manager.'))
        } else resolve()
      })
