...
const routes = [
  ...
  { path: '/conversas', component: () => import('@/views/ConversationsView.vue'), meta: { permission: 'messages.read', feature: 'conversations' } },
  ...
  { path: '/ramais', component: () => import('@/views/VoiceExtensionsView.vue'), meta: { permission: 'pbx.read', feature: 'voiceExtensions' } },
  { path: '/filas', component: () => import('@/views/VoiceQueuesView.vue'), meta: { permission: 'pbx.read', feature: 'voiceQueues' } },
  { path: '/fluxos', component: () => import('@/views/FlowsView.vue'), meta: { permission: 'studio.read', feature: 'flows' } },
  { path: '/automacoes', component: () => import('@/views/AutomationsView.vue'), meta: { permission: 'studio.read', feature: 'automations' } },
