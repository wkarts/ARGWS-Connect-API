...
const routes = [
  ...
  { path: '/instancias/:id/integracoes', component: () => import('@/views/InstanceIntegrationsView.vue'), meta: { permission: 'instances.read' } },
  { path: '/instancias/:id/integracoes/:integration', component: () => import('@/views/IntegrationDetailView.vue'), meta: { permission: 'instances.read' } },
  { path: '/instancias/:id/configuracoes/:kind', component: () => import('@/views/InstanceConfigView.vue'), meta: { permission: 'instances.read' } },
