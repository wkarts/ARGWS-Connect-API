...
export const connect = {
  ...
  findHubConfigureDevice: (id: string, deviceId: string, data: any): Promise<any> => invoke('findHubConfigureDevice', id, deviceId, data),
  findHubHistory: (id: string, deviceId: string, params: Record<string, unknown> = {}): Promise<any> => invoke('findHubHistory', id, deviceId, params),
  findHubStream: (id: string, receive: (message: any) => void, signal: AbortSignal): Promise<void> => invoke('findHubStream', id, receive, signal),
  ...
  findHubLocate: (id: string, deviceId: string, timeoutMs = 30000): Promise<any> => invoke('findHubLocate', id, deviceId, timeoutMs),
  findHubStartTracking: (id: string, deviceId: string, intervalSeconds = 60): Promise<any> => invoke('findHubStartTracking', id, deviceId, intervalSeconds),
  findHubStopTracking: (id: string, deviceId: string): Promise<any> => invoke('findHubStopTracking', id, deviceId),
  findHubPositions: (id: string, deviceId: string, limit = 100): Promise<any[]> => invoke('findHubPositions', id, deviceId, limit),
