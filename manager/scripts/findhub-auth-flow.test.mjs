...
function harness({ version='0.1.5', exchangeFailure, exchangeWait }={}) {
...
test('helper version validation rejects old/missing/malformed versions before any Google session',async()=>{
  ...
  assert.equal(state.compatibleFindHubHelper('0.1.5'),true);assert.equal(state.compatibleFindHubHelper('0.2.0'),true);
});
