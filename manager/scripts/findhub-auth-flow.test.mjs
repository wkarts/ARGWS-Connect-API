...
function harness({ version='0.1.6', exchangeFailure, exchangeWait }={}) {
...
test('helper version validation rejects old/missing/malformed versions before any Google session',async()=>{
  for(const value of ['0.1.0','0.1.1','0.1.2','0.1.3','0.1.4',undefined,'invalid']){
  ...
  assert.equal(state.compatibleFindHubHelper('0.1.6'),true);assert.equal(state.compatibleFindHubHelper('0.2.0'),true);
});
