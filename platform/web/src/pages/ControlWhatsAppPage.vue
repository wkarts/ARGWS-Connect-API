      ...
      <div class="flex flex-wrap items-start gap-4">
        ...
        <div class="flex flex-wrap justify-end gap-2">
          <template v-if="item.operations_available">
            ...
            <button v-if="item.connection.state==='CONNECTED'" class="btn-secondary !px-3 !py-2 text-teal-700" @click="openTest(item)"><Send :size="15"/>Testar envio</button>
