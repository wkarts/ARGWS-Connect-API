...
STACK_NAME="develop"
IMAGE_POLICY="ghcr.io/wkarts/argws-connect-api:develop"
...
text = re.sub(r'^ARGWS_CONNECT_API_IMAGE=.*$', 'ARGWS_CONNECT_API_IMAGE=ghcr.io/wkarts/argws-connect-api:develop', text, flags=re.M)
path.write_text(text)
PYENV
chmod 600 .env
