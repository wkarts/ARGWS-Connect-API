...
projeto e rede do perfil production. Os dados padrao ficam em `../volumes`, no diretorio do deploy pai.
...
Este perfil conserva `latest` para API/DOCs; bases seguem o catalogo GHCR existente.
