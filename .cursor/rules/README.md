# ARGWS Connect API Cursor Rules

Este diretório contém as regras e configurações do Cursor IDE para o projeto ARGWS Connect API.

## Estrutura dos Arquivos

### Arquivos Principais (alwaysApply: true)
- **`core-development.mdc`** - Princípios fundamentais de desenvolvimento
- **`project-context.mdc`** - Contexto específico do projeto ARGWS Connect API
...
- Padrões de código específicos do ARGWS Connect API
...
Este sistema de regras garante consistência no código e facilita o desenvolvimento seguindo os padrões estabelecidos do ARGWS Connect API.
